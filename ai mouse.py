...
pX2, pY2 = 0, 0  # Previous x and y location of dragging
cX2, cY2 = 0, 0  # Current x and y location of dragging 
...
while True:
    ...
    if len(lmList) != 0:
        ...
        if finger[1] == 0 and finger[0] == 1:  # Checks to see if the pointer finger is down and thumb finger is up
        ...
        elif finger[1] == 0 and finger[4] == 1:  # Checks to see if the pointer finger is down and pinky finger is up
            ...
            y4 = numpy.interp(y1, (75, 480 - 75), (0, hScr))  # Converts the height of the window relative to the screen height
            
            cX2 = pX2 + (x4 - pX2) / 7  # Stores previous x locations to update current x location
            cY2 = pY2 + (y4 - pY2) / 7  # Stores previous y locations to update current y location
